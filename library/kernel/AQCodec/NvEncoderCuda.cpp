 ...
 * Last modified : 2020-06-17 08:14
 * Filename      : NvEncoderCuda.cpp
 * Description   : 
 * *******************************************************/
/*
...
NvEncoderCuda::NvEncoderCuda(CUcontext cuContext, uint32_t nWidth, uint32_t nHeight, NV_ENC_BUFFER_FORMAT eBufferFormat, NvEncoderNotify& rNotify,
    uint32_t nExtraOutputDelay, bool bMotionEstimationOnly, bool bOutputInVideoMemory):
    NvEncoder(NV_ENC_DEVICE_TYPE_CUDA, cuContext, nWidth, nHeight, eBufferFormat, nExtraOutputDelay, rNotify, bMotionEstimationOnly, bOutputInVideoMemory),
