...
inline void GetConstants(int iMatrix, float &wr, float &wb, int &black, int &white, int &max) {
    // Default is BT709
...
void Nv12ToColor32(uint8_t *dpNv12, int nNv12Pitch, uint8_t *dpBgra, int nBgraPitch, int nWidth, int nHeight,  uint8_t* gamaTransLut, float* YUVDiff, int iMatrix = 0);
template <class COLOR64>
void Nv12ToColor64(uint8_t *dpNv12, int nNv12Pitch, uint8_t *dpBgra, int nBgraPitch, int nWidth, int nHeight, int iMatrix = 0);

template <class COLOR32>
void P016ToColor32(uint8_t *dpP016, int nP016Pitch, uint8_t *dpBgra, int nBgraPitch, int nWidth, int nHeight, uint8_t* gamaTransLut, float* YUVDiff, int iMatrix = 4);
template <class COLOR64>
